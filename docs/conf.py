...
module_dir = os.path.join(__location__, "../src/singlecellexperiment")
try:
...
try:
    ...
    version = get_version("singlecellexperiment")
except Exception:
    version = "unknown"
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/biocpy/singlecellexperiment",
    "source_branch": "main",
...
htmlhelp_basename = "singlecellexperiment-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "singlecellexperiment Documentation", "Jayaram Kancherla", "manual")
]
